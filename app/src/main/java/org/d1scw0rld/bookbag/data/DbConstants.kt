...
object DbConstants {
    ...
    fun initFields(resources: android.content.res.Resources) {
        ...
        FIELDS.add(Field(FLD_DESCRIPTION, resources.getString(R.string.fld_description), Field.TYPE_TEXT).setInputType(android.text.InputType.TYPE_CLASS_TEXT or android.text.InputType.TYPE_TEXT_FLAG_MULTI_LINE).setVisibility(false))
        FIELDS.add(Field(FLD_SERIE, resources.getString(R.string.fld_series), Field.TYPE_TEXT_AUTOCOMPLETE))
